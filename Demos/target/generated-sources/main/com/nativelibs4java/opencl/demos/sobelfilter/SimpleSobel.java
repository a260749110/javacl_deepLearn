...
public class SimpleSobel extends CLAbstractUserProgram {
	...
	public synchronized CLEvent simpleSobel(CLQueue commandQueue, CLImage2D input, int width, int height, CLBuffer<Float > gradientOutput, CLBuffer<Float > directionOutput, int globalWorkSizes[], int localWorkSizes[], CLEvent... eventsToWaitFor) throws CLBuildException {
	...
	/** <i>native declaration : com\nativelibs4java\opencl\demos\sobelfilter\SimpleSobel.cl</i> */
